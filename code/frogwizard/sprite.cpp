...
const uint8_t circleSprite1[] FROGBOY_ROM_DATA = {
    0x04, 0x10, 0x10,
    0x00, 0x00, 0x00, 0x84,
    0x08, 0x00, SPRITE_ATTR_HFLIP, 0x84,
    0x00, 0x08, SPRITE_ATTR_VFLIP, 0x84,
    0x08, 0x08, SPRITE_ATTR_HFLIP | SPRITE_ATTR_VFLIP, 0x84,
};
...
const uint8_t doorSprite1[] FROGBOY_ROM_DATA = {
    0x04, 0x10, 0x10,
    0x00, 0x00, 0x00, 0x4B,
    0x08, 0x00, SPRITE_ATTR_HFLIP, 0x4B,
    0x00, 0x08, 0x00, 0x5B,
...
void spriteDraw(int16_t x, int16_t y, SpriteType sprite, uint8_t flags) {
    ...
    for(uint8_t i = 0; i != len; ++i) {
        ...
        bool hflip = (xorattr & SPRITE_ATTR_HFLIP) != 0;
        bool vflip = (xorattr & SPRITE_ATTR_VFLIP) != 0;
